...
**Packet Tracer aufgabe 1:**<br>
In dieser Aufgabe geht es Haptsächlich um das Einrichten eines Heim-Routers.<br>
Dies ist die Ausgangssituation.<br>
![help](Screenshots/M4_A1.1.png)
1. Ich musste den Cable Splitter per Koaxialkabel mit dem Cable modem und dem TV verbinden.<br>
...
5. der Nächste schritt war das Standart Passwort von admin zu MyPasswort1! zu ändern.<br>
...
9. Ende<br>
![help](Screenshots/ende_1.png)<br>
